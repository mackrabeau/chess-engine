...
// White queen-side castle (e1 to c1): squares d1 (3), c1 (2)
constexpr U64 WQ_CASTLE_MASK = (1ULL << 3) | (1ULL << 2);

// Black king-side castle (e8 to g8): squares f8 (61), g8 (62)
constexpr U64 BK_CASTLE_MASK  = (1ULL << 61) | (1ULL << 62);
// Black queen-side castle (e8 to c8): squares d8 (59), c8 (58)
constexpr U64 BQ_CASTLE_MASK = (1ULL << 59) | (1ULL << 58);
